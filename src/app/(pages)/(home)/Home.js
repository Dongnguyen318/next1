  ...
  return (
    <>
      <div className="relative banner">
        <div className="absolute bottom-[-4rem] left-[50%] -translate-x-1/2 p-[2rem] bg-primary shadow-xl rounded-md"></div>
      </div>
      <h2 className="text-center text-[3rem] font-semibold mt-[8rem]">
        Điểm đến hiện có
      </h2>
            ...
            >
              ...
              <div className="p-[1.4rem] w-[50%]">
                <div className="flex items-center">
                  <MdLocationOn color="#FFD330" fontSize={"1.4rem"} />
                ...
                <div className="flex items-center justify-between mt-6">
                  <Link
                    href={`/tour/${altSlug(name)}-${altSlug(content)}~${
                      tour.id
                    }`}
                  ...
                  <Link
                    href={`/checkout/${altSlug(name)}-${altSlug(content)}~${
                      tour.id
                    }`}
                    className="btn text-yellow-500 font-semibold py-[0.5rem]"
                  >
